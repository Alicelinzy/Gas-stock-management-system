 ...
 <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    <div><h1 class="app-page-title">Distributer</h1></div>
			    
			    <div class="py-2"> <a class="btn app-btn-primary" href="distributer">View All Distributer</a></div>
			    <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
				    <div class="inner">
					    <div class="app-card-body p-3 p-lg-4">
						                    <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                <h3 class="section-title">Add Distrubuter</h3>
		                <div class="section-intro">Adding All Required Info For Distributer </div>
	                </div>
  ...
  <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
							    ...
							    <form class="settings-form" id="addDistributerNow">
								    <div class="mb-3">
									...
									<button type="submit" id="kalisa" class="btn app-btn-primary" >Add Distributer</button>
...
$(document).on('submit', '#addDistributerNow', function(event2){
