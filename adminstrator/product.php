  ...
  <circle cx="3.5" cy="10.5" r=".5"/>
    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    <div><h1 class="app-page-title">Product</h1></div>
			    
			    <div class="py-2"> <a class="btn app-btn-primary" href="add-product">Add Product</a></div>
			    <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      $select_cate = "SELECT * FROM category WHERE cat_id='".$fetch_product['cat_id']."'";
                      $prepare_cate = $connect -> prepare($select_cate);
                      $prepare_cate -> execute();
                      $fetch_cate = $prepare_cate -> fetch(PDO::FETCH_ASSOC);
                        $select_brand = "SELECT * FROM brand WHERE br_id='".$fetch_cate['br_id']."'";
                      ...
                      <tr>
                        ...
                        <td><?php echo $fetch_brand['brand_name']; ?></td>
                         <td><?php echo $fetch_product['gas_price']; ?></td>
                          <td><?php echo $fetch_product['quantity']; ?></td>
                        <td><?php echo $fetch_cate['kilogram']; ?></td>
                      
                        <td>
                          <div class="dropdown">
                            <a href="stock?product=<?php echo $fetch_product['pr_id']; ?>" class="btn app-btn-primary" >
                            View Stock In<i class="bx bx-dots-vertical-rounded"></i>
                            </a>
