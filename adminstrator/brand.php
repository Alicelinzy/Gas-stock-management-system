       ...
       <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    <div><h1 class="app-page-title">Brand</h1></div>
			    
			    <div class="py-2"> <a class="btn app-btn-primary" href="add-brand">Add Brand</a></div>
			    <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      <tr>
                        ...
                        <td><?php echo $fetch_brand['status']; ?>
                        </td>
                      
                        <td>
                          <div class="dropdown">
                            <a href="category?brand=<?php echo $fetch_brand['br_id']; ?>" class="btn app-btn-primary" >
                            Category In<i class="bx bx-dots-vertical-rounded"></i>
                            </a>
